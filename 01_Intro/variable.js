...
var num = 234.9; // We can also write this as we know that it is a number and it is obvious so it will automatically asign the variable as number. so there is no need to explicity mark it as number
console.log(num);
